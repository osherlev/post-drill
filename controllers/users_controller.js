...
const loginUser = async (req, res) => {
    try {
        ...
        const accessToken = await token.generateTokens(existingUser);
        token.updateCookies(accessToken, res);
...
module.exports = {registerUser, getAllUsers, getUserById, loginUser, logout}